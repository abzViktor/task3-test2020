...
import { Card, Button, FormControl } from '@material-ui/core';
...
export default function FormComponent() {
  ...
  const trimSpaces = (val) => val.replace(/\s*/g, '');

  const lengthMask = (val, length) => val.substr(0, length);
  ...
  return (
    <Card>
      ...
      <form noValidate title="Task 1 2020test Form">
        ...
        <div>
          <FormControl>
            <InputComponent
              label="Lite email"
              type="text"
              onBlur={validateLiteEmail}
              onChange={changeHandler('liteEmail')}
        ...
        <div>
          <FormControl>
            <InputComponent
              ...
              type="text"
              onBlur={validateIdMask}
              onChange={changeHandler('idMask')}
        ...
        <div className="mb-1">
          <FormControl>
            ...
            <InputMask
              ...
              onBlur={validateNumberMask}
              onChange={changeHandler('phoneMask')}
              value={inputState.value.phoneMaskValue}
              id="number"
              required="true"
            >
        ...
        <div>
          <FormControl>
            <InputComponent
              ...
              type="text"
              onBlur={validateAdditionalNumber}
              onChange={changeHandler('additionalNumber')}
        ...
        <div className="mb-1">
          <FormControl>
            ...
            <InputMask
              mask="9999-9999"
              onBlur={validatePasswordMask}
              onChange={changeHandler('passwordMask')}
              value={inputState.value.passwordMaskValue}
              id="password"
              required="true"
            >
      ...
      <div className="button-holder">
        <Button
          disabled={(inputState.isValid.additionalNumberIsInvalid || inputState.isValid.emailIsInvalid
