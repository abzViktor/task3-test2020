...
export default function Header() {
    return(
        <header className="container">
            ...
            <nav>
                <ul>
                    <li><a className="primary" href="#">About me</a></li>
                    <li><a className="primary" href="#">Relationships</a></li>
                    <li><a className="primary" href="#">Users</a></li>
                    <li><a className="primary" href="#">Sign up</a></li>
                </ul>
            </nav>
